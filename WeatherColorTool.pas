...
implementation
  uses xEditAPI,
  Buttons, Classes, ComCtrls, Contnrs, Controls,
  Dialogs, ExtCtrls, Forms, Graphics, Menus, StdCtrls,
  SysUtils, Windows, StrUtils, Checklst;
...
var
  ...
  //LE
  btnLoadCloudLayerColors, btnLoadWeatherColors, btnLoadLightingColors: TButton;
...
// LE
//============================================================================
// load settings for weather colors
procedure btnLoadWeatherColorsClick(Sender: TObject);
begin
  if not CheckEditable(Weather) then
    Exit;

  // Read in weather colors...
